...
export default function OrderLeftSection() {
  ...
  const fetchOrderStatus = async () => {
    ...
    try {
      const res = await fetch(
        `https://xtreativeapi.onrender.com/orders/${origId}/status/`,
        {
          method: "GET",
          headers: {
  ...
  const handleConfirmShipment = async (itemId) => {
    ...
    try {
      const origId = parseInt(orderId, 10) - OFFSET;
      const res = await fetch(
        `https://xtreativeapi.onrender.com/orders/${origId}/confirm-warehouse/`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleMarkSent = async () => {
    ...
    try {
      const origId = parseInt(orderId, 10) - OFFSET;
      const res = await fetch(
        `https://xtreativeapi.onrender.com/orders/${origId}/mark-sent/`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",

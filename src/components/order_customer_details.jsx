...
function PaymentInformationCard({ order }) {
  ...
  // Guard against missing or non-array paymentMethods
...
function CustomerDetailsPlaceholderCard({ order }) {
  ...
  // Guard against missing users array
  const safeUsers = Array.isArray(users) ? users : [];
  
  const customer =
    safeUsers.find((u) => Number(u.id) === Number(order.customer)) || {};
